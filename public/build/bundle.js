...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$3, 36, 2, 610);
    			add_location(button1, file$3, 37, 2, 660);
    			attr_dev(div, "class", "buttons svelte-1dke330");
    			add_location(div, file$3, 35, 0, 585);
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const keydown_handler = e => e.key === "Enter" && _onOkay();
    ...
    // (209:6) {#each $forsteko.filter((t) => t.erIKo) as timinist (timinist.id)}
    function create_each_block_2(key_1, ctx) {
    	let label;
    	let t0_value = /*timinist*/ ctx[26].navn + "";
    	let t0;
    	let t1;
    	let button;
    	let t3;
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[12](/*timinist*/ ctx[26]);
    	}
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(button, file$1, 211, 10, 6470);
    			attr_dev(label, "class", "svelte-q7q1vj");
    			add_location(label, file$1, 209, 8, 6411);
    			this.first = label;
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*$forsteko*/ 4 && t0_value !== (t0_value = /*timinist*/ ctx[26].navn + "")) set_data_dev(t0, t0_value);
    		},
    		r: function measure() {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(209:6) {#each $forsteko.filter((t) => t.erIKo) as timinist (timinist.id)}",
    		ctx
    	});
    ...
    // (222:6) {#each $nteko as timinist (timinist.id)}
    function create_each_block_1(key_1, ctx) {
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[13](/*timinist*/ ctx[26]);
    	}
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t3 = space();
    			attr_dev(button, "class", "delete svelte-q7q1vj");
    			add_location(button, file$1, 228, 10, 6912);
    			attr_dev(label, "class", "svelte-q7q1vj");
    			add_location(label, file$1, 222, 8, 6744);
    			this.first = label;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, label, anchor);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty[0] & /*$nteko*/ 2) && t0_value !== (t0_value = /*timinist*/ ctx[26].navn + "")) set_data_dev(t0, t0_value);
    		},
    		r: function measure() {
    			rect = label.getBoundingClientRect();
    		},
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				...
    				label_intro = create_in_transition(label, receive, { key: /*timinist*/ ctx[26].id });
    				label_intro.start();
    			});
    		...
    		o: function outro(local) {
    			...
    			label_outro = create_out_transition(label, send, { key: /*timinist*/ ctx[26].id });
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(label);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(222:6) {#each $nteko as timinist (timinist.id)}",
    		ctx
    	});
    ...
    // (238:6) {#each $counter as timinist (timinist.id)}
    function create_each_block(key_1, ctx) {
    	let label;
    	let t0_value = /*timinist*/ ctx[26].navn + "";
    	let t0;
    	let t1;
    	let t2_value = /*timinist*/ ctx[26].vaffelcount + "";
    	let t2;
    	let t3;
    	let button0;
    	let t5;
    	...
    	function click_handler_2() {
    		return /*click_handler_2*/ ctx[14](/*timinist*/ ctx[26]);
    	}

    	function click_handler_3() {
    		return /*click_handler_3*/ ctx[15](/*timinist*/ ctx[26]);
    	}
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(button0, file$1, 244, 10, 7369);
    			attr_dev(button1, "class", "decrement svelte-q7q1vj");
    			add_location(button1, file$1, 247, 10, 7483);
    			attr_dev(label, "class", "svelte-q7q1vj");
    			add_location(label, file$1, 238, 8, 7177);
    			this.first = label;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, label, anchor);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty[0] & /*$counter*/ 1) && t0_value !== (t0_value = /*timinist*/ ctx[26].navn + "")) set_data_dev(t0, t0_value);
    			if ((!current || dirty[0] & /*$counter*/ 1) && t2_value !== (t2_value = /*timinist*/ ctx[26].vaffelcount + "")) set_data_dev(t2, t2_value);
    		},
    		r: function measure() {
    			rect = label.getBoundingClientRect();
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(238:6) {#each $counter as timinist (timinist.id)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const get_key = ctx => /*timinist*/ ctx[26].id;
    	...
    	const get_key_1 = ctx => /*timinist*/ ctx[26].id;
    	...
    	const get_key_2 = ctx => /*timinist*/ ctx[26].id;
    	...
    	const block = {
    		c: function create() {
    			...
    			document_1.title = "Vaffeltirsdag";
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button0, "click", /*showImport*/ ctx[9], false, false, false),
    					listen_dev(button1, "click", /*showExport*/ ctx[10], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			if (!current || dirty[0] & /*$transformed*/ 8 && input_style_value !== (input_style_value = "transform: translate3d(" + /*$transformed*/ ctx[3] + "px, 0, 0)")) {
    				attr_dev(input, "style", input_style_value);
    			}

    			if (dirty[0] & /*skipById, $forsteko*/ 68) {
    			...
    			if (dirty[0] & /*$counter, decrement, increment*/ 385) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function add(input) {
    		...
    		if ($forsteko.filter(timinist => timinist.navn === navn).length == 0) {
    			...
    			input.value = "";
    		} else if ($nteko.filter(timinist => timinist.navn == navn).length == 0 && $forsteko.filter(timinist => timinist.navn === navn)[0].erIKo === false) {
    	...
    	function next(input) {
    		...
    		if ($forsteko.filter(timinist => timinist.erIKo).length > 0) {
    			...
    			set_store_value(forsteko, $forsteko[idx].erIKo = false, $forsteko);
    			popped = $forsteko[idx];
    	...
    	function increment(tiministid) {
    		const idx = $counter.findIndex(timinist => timinist.id == tiministid);

    		if (idx && $counter[idx]) {
    			set_store_value(counter, $counter[idx].vaffelcount += 1, $counter);
    			counter.set($counter);
    		}
    	}

    	function decrement(tiministid) {
    		const idx = $counter.findIndex(timinist => timinist.id == tiministid);
    	...
    	const click_handler_2 = timinist => increment(timinist.id);
    	const click_handler_3 = timinist => decrement(timinist.id);
